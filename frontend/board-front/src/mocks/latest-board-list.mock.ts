...
// 테스트 과정에서 컴포넌트를 화면에서 확인해보기 위해 사용되는 목 객체
const latestBoardListMock: BoardListItem[] = [
  {
    ...
    "boardTitleImage": 'https://images.pexels.com/photos/29074352/pexels-photo-29074352.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    "favoriteCount": 0,
    "commentCount": 0,
    "viewCount": 0,
    "writeDatetime": "2023.08.18. 00:54:27",
    "writeNickname": "안녕하세요나는주코야키",
    "writeProfileImage": 'https://images.pexels.com/photos/25682003/pexels-photo-25682003.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  },
  {
    "boardNumber": 1,
    "title": "오늘 점심 뭐먹지 맛있는 거 먹고 싶은데 추천 부탁 오늘 점심 뭐먹지 맛있는 거 먹고 싶은데",
